...
[MemoryDiagnoser]
public class RealTimestampsByteStreamSplitColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealTimestampsByteStreamSplit"));
...
[MemoryDiagnoser]
public class RealTimestampsByteStreamSplitColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealTimestampsByteStreamSplitRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsByteStreamSplitColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
