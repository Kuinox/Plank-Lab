...
[ParquetSchema]
sealed partial class SyntheticDoubleByteStreamSplitRow
{
    ...
    public static SyntheticDoubleByteStreamSplitRow[] CreateRows(int count)
    {
        var rows = new SyntheticDoubleByteStreamSplitRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticDoubleByteStreamSplitRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticDoubleByteStreamSplitRow[] rows)
    {
...
public class SyntheticDoubleByteStreamSplitPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoubleByteStreamSplit", "Plank", out _expectedOutputBytes)];
    }
    ...
    public void GlobalSetupRead()
    {
        ...
        _reader = SyntheticDoubleByteStreamSplitRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticDoubleByteStreamSplitRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticDoubleByteStreamSplitParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticDoubleByteStreamSplitRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticDoubleByteStreamSplitRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoubleByteStreamSplit", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticDoubleByteStreamSplitRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticDoubleByteStreamSplitRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticDoubleByteStreamSplitParquetNetBenchmarks
{
    SyntheticDoubleByteStreamSplitRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoubleByteStreamSplit", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticDoubleByteStreamSplit");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticDoubleByteStreamSplitRow>(_stream!);
        double sum = 0;
