...
public class RealInt64ByteStreamSplitPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("RealInt64ByteStreamSplit", "Plank", out _expectedOutputBytes);
    }
...
public class RealInt64ByteStreamSplitParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("RealInt64ByteStreamSplit", "ParquetSharp", out _expectedOutputBytes);
    }
...
public class RealInt64ByteStreamSplitParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("RealInt64ByteStreamSplit", "Parquet.Net", out _expectedOutputBytes);
    }
