...
public class SyntheticInt32ByteStreamSplitPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt32ByteStreamSplit|Plank|" + file.Length);
...
public class SyntheticInt32ByteStreamSplitParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt32ByteStreamSplit|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticInt32ByteStreamSplitRow.CreateReadFile(_rows);
...
public class SyntheticInt32ByteStreamSplitParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt32ByteStreamSplit|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticInt32ByteStreamSplitRow.CreateReadFile(_rows);
    }
