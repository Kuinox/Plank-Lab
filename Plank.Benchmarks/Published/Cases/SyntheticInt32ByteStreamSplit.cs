...
[ParquetSchema]
sealed partial class SyntheticInt32ByteStreamSplitRow
{
    ...
    public static SyntheticInt32ByteStreamSplitRow[] CreateRows(int count)
    {
        var rows = new SyntheticInt32ByteStreamSplitRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticInt32ByteStreamSplitRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticInt32ByteStreamSplitRow[] rows)
    {
...
public class SyntheticInt32ByteStreamSplitPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt32ByteStreamSplit", "Plank", out _expectedOutputBytes)];
    }
    ...
    public void GlobalSetupRead()
    {
        ...
        _reader = SyntheticInt32ByteStreamSplitRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticInt32ByteStreamSplitRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticInt32ByteStreamSplitParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticInt32ByteStreamSplitRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticInt32ByteStreamSplitRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt32ByteStreamSplit", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticInt32ByteStreamSplitRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticInt32ByteStreamSplitRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticInt32ByteStreamSplitParquetNetBenchmarks
{
    SyntheticInt32ByteStreamSplitRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt32ByteStreamSplit", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticInt32ByteStreamSplit");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticInt32ByteStreamSplitRow>(_stream!);
        ulong sum = 0;
