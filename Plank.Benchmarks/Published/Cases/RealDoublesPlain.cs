...
[ParquetSchema]
sealed partial class RealDoublesPlainRow
{
    ...
    public static byte[] CreateReadFile(RealDoublesPlainRow[] rows)
    {
...
[MemoryDiagnoser]
public class RealDoublesPlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesPlain", "Plank", out _expectedOutputBytes)];
    }
...
[MemoryDiagnoser]
public class RealDoublesPlainParquetSharpBenchmarks
{
    ...
    ParquetRowReader<RealDoublesPlainRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesPlain", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealDoublesPlainRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealDoublesPlainParquetNetBenchmarks
{
    RealDoublesPlainRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesPlain", "Parquet.Net", out _expectedOutputBytes)];
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealDoublesPlainRow>(_stream!);
        double sum = 0;
