...
[MemoryDiagnoser]
public class RealInt64ByteStreamSplitColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealInt64ByteStreamSplit"));
...
[MemoryDiagnoser]
public class RealInt64ByteStreamSplitColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt64ByteStreamSplitRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64ByteStreamSplitColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealInt64ByteStreamSplitColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt64ByteStreamSplitRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64ByteStreamSplitColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealInt64ByteStreamSplit");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
