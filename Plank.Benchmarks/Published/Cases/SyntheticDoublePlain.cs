...
[ParquetSchema]
sealed partial class SyntheticDoublePlainRow
{
    ...
    public static SyntheticDoublePlainRow[] CreateRows(int count)
    {
        var rows = new SyntheticDoublePlainRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticDoublePlainRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticDoublePlainRow[] rows)
    {
...
public class SyntheticDoublePlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoublePlain", "Plank", out _expectedOutputBytes)];
    }
    ...
    public void GlobalSetupRead()
    {
        ...
        _reader = SyntheticDoublePlainRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticDoublePlainRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticDoublePlainParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticDoublePlainRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticDoublePlainRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoublePlain", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticDoublePlainRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticDoublePlainRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticDoublePlainParquetNetBenchmarks
{
    SyntheticDoublePlainRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticDoublePlain", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticDoublePlain");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticDoublePlainRow>(_stream!);
        double sum = 0;
