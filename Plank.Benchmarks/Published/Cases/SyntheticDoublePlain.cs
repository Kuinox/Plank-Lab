...
public class SyntheticDoublePlainPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticDoublePlain|Plank|" + file.Length);
...
public class SyntheticDoublePlainParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticDoublePlain|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticDoublePlainRow.CreateReadFile(_rows);
...
public class SyntheticDoublePlainParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticDoublePlain|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticDoublePlainRow.CreateReadFile(_rows);
    }
