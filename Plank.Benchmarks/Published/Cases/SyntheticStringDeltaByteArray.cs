...
public class SyntheticStringDeltaByteArrayPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringDeltaByteArray", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        var file = BenchmarkFixtures.LoadReadFile("SyntheticStringDeltaByteArray");
...
public class SyntheticStringDeltaByteArrayParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringDeltaByteArray", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class SyntheticStringDeltaByteArrayParquetNetBenchmarks
{
    ...
    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticStringDeltaByteArray");
