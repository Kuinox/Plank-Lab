...
[MemoryDiagnoser]
public class RealDoublesDictionaryColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealDoublesDictionary"));
...
[MemoryDiagnoser]
public class RealDoublesDictionaryColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealDoublesDictionaryRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesDictionaryColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealDoublesDictionaryColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    byte[] _file = null!;
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealDoublesDictionary");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
