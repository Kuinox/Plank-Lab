...
[ParquetSchema]
sealed partial class SyntheticTimestampDeltaBinaryPackedRow
{
    [ParquetColumn("value_0", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_0"), JsonPropertyName("value_0")]
    public DateTime Value0 { get; set; }

    [ParquetColumn("value_1", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_1"), JsonPropertyName("value_1")]
    public DateTime Value1 { get; set; }

    [ParquetColumn("value_2", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_2"), JsonPropertyName("value_2")]
    public DateTime Value2 { get; set; }

    [ParquetColumn("value_3", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_3"), JsonPropertyName("value_3")]
    public DateTime Value3 { get; set; }

    [ParquetColumn("value_4", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_4"), JsonPropertyName("value_4")]
    public DateTime Value4 { get; set; }

    [ParquetColumn("value_5", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_5"), JsonPropertyName("value_5")]
    public DateTime Value5 { get; set; }

    [ParquetColumn("value_6", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_6"), JsonPropertyName("value_6")]
    public DateTime Value6 { get; set; }

    [ParquetColumn("value_7", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_7"), JsonPropertyName("value_7")]
    public DateTime Value7 { get; set; }

    [ParquetColumn("value_8", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_8"), JsonPropertyName("value_8")]
    public DateTime Value8 { get; set; }

    [ParquetColumn("value_9", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_9"), JsonPropertyName("value_9")]
    public DateTime Value9 { get; set; }

    [ParquetColumn("value_10", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_10"), JsonPropertyName("value_10")]
    public DateTime Value10 { get; set; }

    [ParquetColumn("value_11", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_11"), JsonPropertyName("value_11")]
    public DateTime Value11 { get; set; }

    [ParquetColumn("value_12", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_12"), JsonPropertyName("value_12")]
    public DateTime Value12 { get; set; }

    [ParquetColumn("value_13", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_13"), JsonPropertyName("value_13")]
    public DateTime Value13 { get; set; }

    [ParquetColumn("value_14", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_14"), JsonPropertyName("value_14")]
    public DateTime Value14 { get; set; }

    [ParquetColumn("value_15", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_15"), JsonPropertyName("value_15")]
    public DateTime Value15 { get; set; }

    [ParquetColumn("value_16", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_16"), JsonPropertyName("value_16")]
    public DateTime Value16 { get; set; }

    [ParquetColumn("value_17", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_17"), JsonPropertyName("value_17")]
    public DateTime Value17 { get; set; }

    [ParquetColumn("value_18", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_18"), JsonPropertyName("value_18")]
    public DateTime Value18 { get; set; }

    [ParquetColumn("value_19", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_19"), JsonPropertyName("value_19")]
    public DateTime Value19 { get; set; }

    [ParquetColumn("value_20", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_20"), JsonPropertyName("value_20")]
    public DateTime Value20 { get; set; }

    [ParquetColumn("value_21", Encodings = [EncodingKind.DeltaBinaryPacked], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_21"), JsonPropertyName("value_21")]
    public DateTime Value21 { get; set; }

    public static SyntheticTimestampDeltaBinaryPackedRow[] CreateRows(int count)
    {
        var rows = new SyntheticTimestampDeltaBinaryPackedRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticTimestampDeltaBinaryPackedRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticTimestampDeltaBinaryPackedRow[] rows)
    {
...
[MemoryDiagnoser]
public class SyntheticTimestampDeltaBinaryPackedPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticTimestampDeltaBinaryPacked|Plank|" + file.Length);
        _outputCapacity = BenchmarkData.OutputCapacity(file.Length);
        _output.Dispose();

        _source = new MemoryReadSource(file);
        _reader = SyntheticTimestampDeltaBinaryPackedRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
        _ = Read();
    }
    ...
    public void Write()
    {
        using var writer = SyntheticTimestampDeltaBinaryPackedRow.CreateRowWriter(_output, _options);
        _pinning.Wait();
...
[MemoryDiagnoser]
public class SyntheticTimestampDeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    ParquetRowReader<SyntheticTimestampDeltaBinaryPackedRow>? _reader;
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticTimestampDeltaBinaryPacked|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticTimestampDeltaBinaryPackedRow.CreateReadFile(_rows);
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticTimestampDeltaBinaryPackedRow>(_source);
    }
