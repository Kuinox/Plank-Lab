...
[MemoryDiagnoser]
public class RealTimestampsDeltaBinaryPackedColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealTimestampsDeltaBinaryPacked"));
...
[MemoryDiagnoser]
public class RealTimestampsDeltaBinaryPackedColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealTimestampsDeltaBinaryPackedRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsDeltaBinaryPackedColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
