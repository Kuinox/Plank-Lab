...
public class RealInt32PlainPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealInt32Plain|Plank|" + file.Length);
    ...
    public void Write()
    {
        using var writer = RealInt32PlainRow.CreateRowWriter(_output, _options);
        _pinning.Wait();
...
public class RealInt32PlainParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealInt32Plain|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = RealInt32PlainRow.CreateReadFile(_rows);
...
public class RealInt32PlainParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|RealInt32Plain|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = RealInt32PlainRow.CreateReadFile(_rows);
    }
