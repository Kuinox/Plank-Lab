...
public class SyntheticStringPlainPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticStringPlain|Plank|" + file.Length);
    ...
    public void Write()
    {
        using var writer = SyntheticStringPlainPlankRow.CreateRowWriter(_output, _options);
        _pinning.Wait();
...
public class SyntheticStringPlainParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticStringPlain|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticStringPlainPlankRow.CreateReadFile(SyntheticStringPlainPlankRow.FromSharp(_rows));
...
public class SyntheticStringPlainParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticStringPlain|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticStringPlainPlankRow.CreateReadFile(SyntheticStringPlainPlankRow.FromNet(_rows));
    }
