...
public class SyntheticStringPlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringPlain", "Plank", out _expectedOutputBytes)];
    }
...
public class SyntheticStringPlainParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringPlain", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class SyntheticStringPlainParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringPlain", "Parquet.Net", out _expectedOutputBytes)];
    }
