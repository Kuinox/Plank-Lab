...
[MemoryDiagnoser]
public class RealTimestampsPlainColumnMultiPlankBenchmarks
{
    ...
    {
        if (_readThreads > 0)
            ColumnParallelism.WriteMarker("RealTimestampsPlainColumnMultiPlankBenchmarks", "read", _readWorkerCount, _readThreads);
...
[MemoryDiagnoser]
public class RealTimestampsPlainColumnMultiParquetSharpBenchmarks
{
    int _columnWorkerCount;
    readonly ColumnParallelism.Tracker _parallelism = new();
    int _readThreads;
