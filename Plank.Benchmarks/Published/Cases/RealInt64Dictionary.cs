...
public class RealInt64DictionaryPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64Dictionary", "Plank", out _expectedOutputBytes)];
    }
...
public class RealInt64DictionaryParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64Dictionary", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class RealInt64DictionaryParquetNetBenchmarks
{
    ...
    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("RealInt64Dictionary");
