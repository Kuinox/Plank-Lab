...
[ParquetSchema]
sealed partial class SyntheticTimestampDictionaryRow
{
    [ParquetColumn("value_0", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_0"), JsonPropertyName("value_0")]
    public DateTime Value0 { get; set; }

    [ParquetColumn("value_1", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_1"), JsonPropertyName("value_1")]
    public DateTime Value1 { get; set; }

    [ParquetColumn("value_2", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_2"), JsonPropertyName("value_2")]
    public DateTime Value2 { get; set; }

    [ParquetColumn("value_3", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_3"), JsonPropertyName("value_3")]
    public DateTime Value3 { get; set; }

    [ParquetColumn("value_4", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_4"), JsonPropertyName("value_4")]
    public DateTime Value4 { get; set; }

    [ParquetColumn("value_5", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_5"), JsonPropertyName("value_5")]
    public DateTime Value5 { get; set; }

    [ParquetColumn("value_6", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_6"), JsonPropertyName("value_6")]
    public DateTime Value6 { get; set; }

    [ParquetColumn("value_7", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_7"), JsonPropertyName("value_7")]
    public DateTime Value7 { get; set; }

    [ParquetColumn("value_8", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_8"), JsonPropertyName("value_8")]
    public DateTime Value8 { get; set; }

    [ParquetColumn("value_9", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_9"), JsonPropertyName("value_9")]
    public DateTime Value9 { get; set; }

    [ParquetColumn("value_10", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_10"), JsonPropertyName("value_10")]
    public DateTime Value10 { get; set; }

    [ParquetColumn("value_11", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_11"), JsonPropertyName("value_11")]
    public DateTime Value11 { get; set; }

    [ParquetColumn("value_12", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_12"), JsonPropertyName("value_12")]
    public DateTime Value12 { get; set; }

    [ParquetColumn("value_13", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_13"), JsonPropertyName("value_13")]
    public DateTime Value13 { get; set; }

    [ParquetColumn("value_14", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_14"), JsonPropertyName("value_14")]
    public DateTime Value14 { get; set; }

    [ParquetColumn("value_15", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_15"), JsonPropertyName("value_15")]
    public DateTime Value15 { get; set; }

    [ParquetColumn("value_16", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_16"), JsonPropertyName("value_16")]
    public DateTime Value16 { get; set; }

    [ParquetColumn("value_17", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_17"), JsonPropertyName("value_17")]
    public DateTime Value17 { get; set; }

    [ParquetColumn("value_18", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_18"), JsonPropertyName("value_18")]
    public DateTime Value18 { get; set; }

    [ParquetColumn("value_19", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_19"), JsonPropertyName("value_19")]
    public DateTime Value19 { get; set; }

    [ParquetColumn("value_20", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_20"), JsonPropertyName("value_20")]
    public DateTime Value20 { get; set; }

    [ParquetColumn("value_21", Encodings = [EncodingKind.RleDictionary], LogicalType = LogicalTypeKind.Timestamp), MapToColumn("value_21"), JsonPropertyName("value_21")]
    public DateTime Value21 { get; set; }

    public static SyntheticTimestampDictionaryRow[] CreateRows(int count)
    {
        var rows = new SyntheticTimestampDictionaryRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticTimestampDictionaryRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticTimestampDictionaryRow[] rows)
    {
...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryPlankBenchmarks
{
    SyntheticTimestampDictionaryRow[] _rows = null!;
    DefaultParquetBufferPool _pool = null!;
    ParquetWriterOptions _options = null!;
    SyntheticTimestampDictionaryRow.PipelineWriter _writer = null!;
    MemoryStream _output = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    MemoryReadSource _source = null!;
    SyntheticTimestampDictionaryRow.RowReader _reader = null!;
    ...
    {
        _rows ??= SyntheticTimestampDictionaryRow.CreateRows(Rows);
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampDictionary", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        var file = BenchmarkFixtures.LoadReadFile("SyntheticTimestampDictionary");
        _source = new MemoryReadSource(file);
        _reader = SyntheticTimestampDictionaryRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticTimestampDictionaryRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticTimestampDictionaryRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticTimestampDictionaryRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampDictionary", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticTimestampDictionaryRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticTimestampDictionaryRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryParquetNetBenchmarks
{
    byte[] _file = null!;
    ...
    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticTimestampDictionary");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticTimestampDictionaryRow>(_stream!);
        long sum = 0;
