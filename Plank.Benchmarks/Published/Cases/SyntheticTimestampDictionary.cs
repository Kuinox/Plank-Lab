...
public class SyntheticTimestampDictionaryPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampDictionary", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticTimestampDictionaryParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampDictionary", "ParquetSharp", out _expectedOutputBytes);
    }
