...
public class SyntheticTimestampDictionaryPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticTimestampDictionary|Plank|" + file.Length);
...
public class SyntheticTimestampDictionaryParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticTimestampDictionary|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticTimestampDictionaryRow.CreateReadFile(_rows);
...
public class SyntheticTimestampDictionaryParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _file = SyntheticTimestampDictionaryRow.CreateReadFile(_rows);
    }
