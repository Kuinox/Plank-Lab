...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("SyntheticTimestampDictionary"));
...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 45455;
    SyntheticTimestampDictionaryRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampDictionaryColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class SyntheticTimestampDictionaryColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 45455;
    byte[] _file = null!;
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("SyntheticTimestampDictionary");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
