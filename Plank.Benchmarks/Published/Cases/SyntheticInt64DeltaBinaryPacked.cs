...
[ParquetSchema]
sealed partial class SyntheticInt64DeltaBinaryPackedRow
{
    [ParquetColumn("value_0", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_0"), JsonPropertyName("value_0")]
    public long Value0 { get; set; }

    [ParquetColumn("value_1", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_1"), JsonPropertyName("value_1")]
    public long Value1 { get; set; }

    [ParquetColumn("value_2", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_2"), JsonPropertyName("value_2")]
    public long Value2 { get; set; }

    [ParquetColumn("value_3", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_3"), JsonPropertyName("value_3")]
    public long Value3 { get; set; }

    [ParquetColumn("value_4", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_4"), JsonPropertyName("value_4")]
    public long Value4 { get; set; }

    [ParquetColumn("value_5", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_5"), JsonPropertyName("value_5")]
    public long Value5 { get; set; }

    [ParquetColumn("value_6", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_6"), JsonPropertyName("value_6")]
    public long Value6 { get; set; }

    [ParquetColumn("value_7", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_7"), JsonPropertyName("value_7")]
    public long Value7 { get; set; }

    [ParquetColumn("value_8", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_8"), JsonPropertyName("value_8")]
    public long Value8 { get; set; }

    [ParquetColumn("value_9", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_9"), JsonPropertyName("value_9")]
    public long Value9 { get; set; }

    [ParquetColumn("value_10", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_10"), JsonPropertyName("value_10")]
    public long Value10 { get; set; }

    [ParquetColumn("value_11", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_11"), JsonPropertyName("value_11")]
    public long Value11 { get; set; }

    [ParquetColumn("value_12", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_12"), JsonPropertyName("value_12")]
    public long Value12 { get; set; }

    [ParquetColumn("value_13", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_13"), JsonPropertyName("value_13")]
    public long Value13 { get; set; }

    [ParquetColumn("value_14", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_14"), JsonPropertyName("value_14")]
    public long Value14 { get; set; }

    [ParquetColumn("value_15", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_15"), JsonPropertyName("value_15")]
    public long Value15 { get; set; }

    [ParquetColumn("value_16", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_16"), JsonPropertyName("value_16")]
    public long Value16 { get; set; }

    [ParquetColumn("value_17", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_17"), JsonPropertyName("value_17")]
    public long Value17 { get; set; }

    [ParquetColumn("value_18", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_18"), JsonPropertyName("value_18")]
    public long Value18 { get; set; }

    [ParquetColumn("value_19", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_19"), JsonPropertyName("value_19")]
    public long Value19 { get; set; }

    [ParquetColumn("value_20", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_20"), JsonPropertyName("value_20")]
    public long Value20 { get; set; }

    [ParquetColumn("value_21", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("value_21"), JsonPropertyName("value_21")]
    public long Value21 { get; set; }

    public static SyntheticInt64DeltaBinaryPackedRow[] CreateRows(int count)
    {
        var rows = new SyntheticInt64DeltaBinaryPackedRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticInt64DeltaBinaryPackedRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticInt64DeltaBinaryPackedRow[] rows)
    {
...
[MemoryDiagnoser]
public class SyntheticInt64DeltaBinaryPackedPlankBenchmarks
{
    SyntheticInt64DeltaBinaryPackedRow[] _rows = null!;
    DefaultParquetBufferPool _pool = null!;
    ParquetWriterOptions _options = null!;
    SyntheticInt64DeltaBinaryPackedRow.PipelineWriter _writer = null!;
    MemoryStream _output = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    MemoryReadSource _source = null!;
    SyntheticInt64DeltaBinaryPackedRow.RowReader _reader = null!;
    ...
    {
        _rows ??= SyntheticInt64DeltaBinaryPackedRow.CreateRows(Rows);
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        var file = BenchmarkFixtures.LoadReadFile("SyntheticInt64DeltaBinaryPacked");
        _source = new MemoryReadSource(file);
        _reader = SyntheticInt64DeltaBinaryPackedRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticInt64DeltaBinaryPackedRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticInt64DeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticInt64DeltaBinaryPackedRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticInt64DeltaBinaryPackedRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticInt64DeltaBinaryPackedRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticInt64DeltaBinaryPackedRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticInt64DeltaBinaryPackedParquetNetBenchmarks
{
    SyntheticInt64DeltaBinaryPackedRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _options.ColumnEncodingHints["value_0"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_1"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_2"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_3"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_4"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_5"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_6"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_7"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_8"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_9"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_10"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_11"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_12"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_13"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_14"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_15"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_16"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_17"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_18"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_19"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_20"] = EncodingHint.DeltaBinaryPacked;
        _options.ColumnEncodingHints["value_21"] = EncodingHint.DeltaBinaryPacked;

        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticInt64DeltaBinaryPacked");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticInt64DeltaBinaryPackedRow>(_stream!);
        ulong sum = 0;
