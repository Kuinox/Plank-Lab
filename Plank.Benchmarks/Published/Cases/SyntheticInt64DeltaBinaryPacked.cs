...
public class SyntheticInt64DeltaBinaryPackedPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticInt64DeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "ParquetSharp", out _expectedOutputBytes);
    }
...
public class SyntheticInt64DeltaBinaryPackedParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64DeltaBinaryPacked", "Parquet.Net", out _expectedOutputBytes);
    }
