...
public class SyntheticInt64DeltaBinaryPackedPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64DeltaBinaryPacked|Plank|" + file.Length);
...
public class SyntheticInt64DeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64DeltaBinaryPacked|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticInt64DeltaBinaryPackedRow.CreateReadFile(_rows);
...
public class SyntheticInt64DeltaBinaryPackedParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64DeltaBinaryPacked|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticInt64DeltaBinaryPackedRow.CreateReadFile(_rows);
    }
