...
[MemoryDiagnoser]
public class RealInt32PlainColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealInt32PlainRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<int?>(RealInt32PlainRow.Schema.LeafColumns[0]);
        _s1 = _writer.CreateSerializedColumn<int?>(RealInt32PlainRow.Schema.LeafColumns[1]);
        _s2 = _writer.CreateSerializedColumn<int?>(RealInt32PlainRow.Schema.LeafColumns[2]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32PlainColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealInt32Plain"));
...
[MemoryDiagnoser]
public class RealInt32PlainColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt32PlainRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32PlainColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealInt32PlainColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt32PlainRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32PlainColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealInt32Plain");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
