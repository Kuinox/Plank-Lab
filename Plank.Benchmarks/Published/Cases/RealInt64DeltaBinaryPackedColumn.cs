...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealInt64DeltaBinaryPackedRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<long?>(RealInt64DeltaBinaryPackedRow.Schema.LeafColumns[0]);
        _s1 = _writer.CreateSerializedColumn<long?>(RealInt64DeltaBinaryPackedRow.Schema.LeafColumns[1]);
        _s2 = _writer.CreateSerializedColumn<long?>(RealInt64DeltaBinaryPackedRow.Schema.LeafColumns[2]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPackedColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealInt64DeltaBinaryPacked"));
...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt64DeltaBinaryPackedRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPackedColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt64DeltaBinaryPackedRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _schema = new Parquet.Schema.ParquetSchema(new Parquet.Schema.DataField<long?>("passenger_count", true), new Parquet.Schema.DataField<long?>("RatecodeID", true), new Parquet.Schema.DataField<long?>("payment_type", true));

        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPackedColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealInt64DeltaBinaryPacked");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
