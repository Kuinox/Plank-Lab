...
[MemoryDiagnoser]
public class RealTimestampsDictionaryColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealTimestampsDictionary"));
...
[MemoryDiagnoser]
public class RealTimestampsDictionaryColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealTimestampsDictionaryRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsDictionaryColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealTimestampsDictionaryColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    byte[] _file = null!;
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealTimestampsDictionary");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
