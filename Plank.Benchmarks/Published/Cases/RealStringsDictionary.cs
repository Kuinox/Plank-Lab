...
[ParquetSchema]
sealed partial class RealStringsDictionaryPlankRow
{
    ...
    public static byte[] CreateReadFile(RealStringsDictionaryPlankRow[] rows)
    {
    ...
    public static RealStringsDictionaryPlankRow[] FromSharp(RealStringsDictionarySharpRow[] source)
    {
        var rows = new RealStringsDictionaryPlankRow[source.Length];
        for (var index = 0; index < rows.Length; index++)
        {
            var value = source[index];
            rows[index] = new RealStringsDictionaryPlankRow
            {
    ...
    public static RealStringsDictionaryPlankRow[] FromNet(RealStringsDictionaryNetRow[] source)
    {
        var rows = new RealStringsDictionaryPlankRow[source.Length];
        for (var index = 0; index < rows.Length; index++)
        {
...
[MemoryDiagnoser]
public class RealStringsDictionaryPlankBenchmarks
{
    RealStringsDictionaryPlankRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionary", "Plank", out _expectedOutputBytes)];
    }
...
[MemoryDiagnoser]
public class RealStringsDictionaryParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;

    RealStringsDictionarySharpRow[] _rows = null!;
    ...
    ParquetRowReader<RealStringsDictionarySharpRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionary", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealStringsDictionarySharpRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealStringsDictionaryParquetNetBenchmarks
{
    RealStringsDictionaryNetRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionary", "Parquet.Net", out _expectedOutputBytes)];
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealStringsDictionaryNetRow>(_stream!);
        ulong sum = 0;
