...
public class RealTimestampsDeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealTimestampsDeltaBinaryPacked|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = RealTimestampsDeltaBinaryPackedRow.CreateReadFile(_rows);
