...
[MemoryDiagnoser]
public class RealInt32DeltaBinaryPackedColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealInt32DeltaBinaryPackedRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<int?>(RealInt32DeltaBinaryPackedRow.Schema.LeafColumns[0]);
        _s1 = _writer.CreateSerializedColumn<int?>(RealInt32DeltaBinaryPackedRow.Schema.LeafColumns[1]);
        _s2 = _writer.CreateSerializedColumn<int?>(RealInt32DeltaBinaryPackedRow.Schema.LeafColumns[2]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32DeltaBinaryPackedColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealInt32DeltaBinaryPacked"));
...
[MemoryDiagnoser]
public class RealInt32DeltaBinaryPackedColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt32DeltaBinaryPackedRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32DeltaBinaryPackedColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealInt32DeltaBinaryPackedColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt32DeltaBinaryPackedRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32DeltaBinaryPackedColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealInt32DeltaBinaryPacked");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
