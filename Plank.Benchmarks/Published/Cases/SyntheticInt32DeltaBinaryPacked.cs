...
public class SyntheticInt32DeltaBinaryPackedPlankBenchmarks
{
    ...
    public void Write()
    {
        using var writer = SyntheticInt32DeltaBinaryPackedRow.CreateRowWriter(_output, _options);
        _pinning.Wait();
...
public class SyntheticInt32DeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt32DeltaBinaryPacked|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticInt32DeltaBinaryPackedRow.CreateReadFile(_rows);
...
public class SyntheticInt32DeltaBinaryPackedParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt32DeltaBinaryPacked|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticInt32DeltaBinaryPackedRow.CreateReadFile(_rows);
    }
