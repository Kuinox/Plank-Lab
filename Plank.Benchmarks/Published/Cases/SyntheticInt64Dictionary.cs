...
public class SyntheticInt64DictionaryPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Dictionary", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticInt64DictionaryParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Dictionary", "ParquetSharp", out _expectedOutputBytes);
    }
