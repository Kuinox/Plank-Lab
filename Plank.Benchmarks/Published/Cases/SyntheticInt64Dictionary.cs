...
public class SyntheticInt64DictionaryParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64Dictionary|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticInt64DictionaryRow.CreateReadFile(_rows);
...
public class SyntheticInt64DictionaryParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _file = SyntheticInt64DictionaryRow.CreateReadFile(_rows);
    }
