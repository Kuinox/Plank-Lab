...
public class RealTaxiDictionaryParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealTaxiDictionary|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = RealTaxiDictionaryPlankRow.CreateReadFile(RealTaxiDictionaryPlankRow.FromSharp(_rows));
...
{
    RealTaxiDictionaryNetRow[] _rows = null!;
    byte[] _file = null!;
    ...
    public void Setup()
    {
        _rows = BenchmarkData.LoadTaxiRows<RealTaxiDictionaryNetRow>();

        _file = RealTaxiDictionaryPlankRow.CreateReadFile(RealTaxiDictionaryPlankRow.FromNet(_rows));
    }
