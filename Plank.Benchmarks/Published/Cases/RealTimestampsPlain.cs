...
[ParquetSchema]
sealed partial class RealTimestampsPlainRow
{
    ...
    public static byte[] CreateReadFile(RealTimestampsPlainRow[] rows)
    {
...
[MemoryDiagnoser]
public class RealTimestampsPlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsPlain", "Plank", out _expectedOutputBytes)];
    }
...
[MemoryDiagnoser]
public class RealTimestampsPlainParquetSharpBenchmarks
{
    ...
    ParquetRowReader<RealTimestampsPlainRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsPlain", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealTimestampsPlainRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealTimestampsPlainParquetNetBenchmarks
{
    RealTimestampsPlainRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealTimestampsPlain", "Parquet.Net", out _expectedOutputBytes)];
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealTimestampsPlainRow>(_stream!);
        long sum = 0;
