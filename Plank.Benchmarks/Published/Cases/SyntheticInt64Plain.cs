...
public class SyntheticInt64PlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticInt64PlainParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "ParquetSharp", out _expectedOutputBytes);
    }
...
public class SyntheticInt64PlainParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "Parquet.Net", out _expectedOutputBytes);
    }
