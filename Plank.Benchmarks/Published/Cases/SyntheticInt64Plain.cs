...
[ParquetSchema]
sealed partial class SyntheticInt64PlainRow
{
    ...
    public static SyntheticInt64PlainRow[] CreateRows(int count)
    {
        var rows = new SyntheticInt64PlainRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticInt64PlainRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticInt64PlainRow[] rows)
    {
...
[MemoryDiagnoser]
public class SyntheticInt64PlainPlankBenchmarks
{
    SyntheticInt64PlainRow[] _rows = null!;
    DefaultParquetBufferPool _pool = null!;
    ParquetWriterOptions _options = null!;
    SyntheticInt64PlainRow.PipelineWriter _writer = null!;
    MemoryStream _output = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    MemoryReadSource _source = null!;
    SyntheticInt64PlainRow.RowReader _reader = null!;
    ...
    {
        _rows ??= SyntheticInt64PlainRow.CreateRows(Rows);
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        var file = BenchmarkFixtures.LoadReadFile("SyntheticInt64Plain");
        _source = new MemoryReadSource(file);
        _reader = SyntheticInt64PlainRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticInt64PlainRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticInt64PlainParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticInt64PlainRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticInt64PlainRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticInt64PlainRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticInt64PlainRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticInt64PlainParquetNetBenchmarks
{
    SyntheticInt64PlainRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticInt64Plain", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticInt64Plain");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticInt64PlainRow>(_stream!);
        ulong sum = 0;
