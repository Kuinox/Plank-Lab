...
public class SyntheticInt64PlainPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64Plain|Plank|" + file.Length);
...
public class SyntheticInt64PlainParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64Plain|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticInt64PlainRow.CreateReadFile(_rows);
...
public class SyntheticInt64PlainParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticInt64Plain|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = SyntheticInt64PlainRow.CreateReadFile(_rows);
    }
