...
[ParquetSchema]
sealed partial class RealInt64DeltaBinaryPackedRow
{
    [ParquetColumn("passenger_count", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("passenger_count"), JsonPropertyName("passenger_count")]
    public long? PassengerCount { get; set; }

    [ParquetColumn("RatecodeID", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("RatecodeID"), JsonPropertyName("RatecodeID")]
    public long? RatecodeId { get; set; }

    [ParquetColumn("payment_type", Encodings = [EncodingKind.DeltaBinaryPacked]), MapToColumn("payment_type"), JsonPropertyName("payment_type")]
    public long? PaymentType { get; set; }

    public static byte[] CreateReadFile(RealInt64DeltaBinaryPackedRow[] rows)
    {
...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPacked", "Plank", out _expectedOutputBytes)];
    }
...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedParquetSharpBenchmarks
{
    ...
    ParquetRowReader<RealInt64DeltaBinaryPackedRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPacked", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealInt64DeltaBinaryPackedRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealInt64DeltaBinaryPackedParquetNetBenchmarks
{
    RealInt64DeltaBinaryPackedRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _options.ColumnEncodingHints["passenger_count"] = EncodingHint.DeltaBinaryPacked;
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64DeltaBinaryPacked", "Parquet.Net", out _expectedOutputBytes)];
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealInt64DeltaBinaryPackedRow>(_stream!);
        ulong sum = 0;
