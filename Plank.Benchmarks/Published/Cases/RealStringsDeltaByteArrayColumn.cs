...
[MemoryDiagnoser]
public class RealStringsDeltaByteArrayColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealStringsDeltaByteArrayPlankRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<ReadOnlyMemory<byte>?>(RealStringsDeltaByteArrayPlankRow.Schema.LeafColumns[0]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDeltaByteArrayColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealStringsDeltaByteArray"));
...
[MemoryDiagnoser]
public class RealStringsDeltaByteArrayColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDeltaByteArrayColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealStringsDeltaByteArrayColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    byte[] _file = null!;
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealStringsDeltaByteArray");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
