...
public class SyntheticBooleanPlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanPlain", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticBooleanPlainParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanPlain", "ParquetSharp", out _expectedOutputBytes);
    }
...
public class SyntheticBooleanPlainParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanPlain", "Parquet.Net", out _expectedOutputBytes);
    }
