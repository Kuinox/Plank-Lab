...
[ParquetSchema]
sealed partial class RealDoublesByteStreamSplitRow
{
    [ParquetColumn("trip_distance", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("trip_distance"), JsonPropertyName("trip_distance")]
    public double? TripDistance { get; set; }

    [ParquetColumn("fare_amount", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("fare_amount"), JsonPropertyName("fare_amount")]
    public double? FareAmount { get; set; }

    [ParquetColumn("extra", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("extra"), JsonPropertyName("extra")]
    public double? Extra { get; set; }

    [ParquetColumn("mta_tax", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("mta_tax"), JsonPropertyName("mta_tax")]
    public double? MtaTax { get; set; }

    [ParquetColumn("tip_amount", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("tip_amount"), JsonPropertyName("tip_amount")]
    public double? TipAmount { get; set; }

    [ParquetColumn("tolls_amount", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("tolls_amount"), JsonPropertyName("tolls_amount")]
    public double? TollsAmount { get; set; }

    [ParquetColumn("improvement_surcharge", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("improvement_surcharge"), JsonPropertyName("improvement_surcharge")]
    public double? ImprovementSurcharge { get; set; }

    [ParquetColumn("total_amount", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("total_amount"), JsonPropertyName("total_amount")]
    public double? TotalAmount { get; set; }

    [ParquetColumn("congestion_surcharge", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("congestion_surcharge"), JsonPropertyName("congestion_surcharge")]
    public double? CongestionSurcharge { get; set; }

    [ParquetColumn("Airport_fee", Encodings = [EncodingKind.ByteStreamSplit]), MapToColumn("Airport_fee"), JsonPropertyName("Airport_fee")]
    public double? AirportFee { get; set; }

    public static byte[] CreateReadFile(RealDoublesByteStreamSplitRow[] rows)
    {
...
[MemoryDiagnoser]
public class RealDoublesByteStreamSplitPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _reader = RealDoublesByteStreamSplitRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
        _ = Read();
    }
    ...
    public void Write()
    {
        using var writer = RealDoublesByteStreamSplitRow.CreateRowWriter(_output, _options);
        _pinning.Wait();
...
[MemoryDiagnoser]
public class RealDoublesByteStreamSplitParquetSharpBenchmarks
{
    ...
    ParquetRowReader<RealDoublesByteStreamSplitRow>? _reader;
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealDoublesByteStreamSplit|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = RealDoublesByteStreamSplitRow.CreateReadFile(_rows);
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealDoublesByteStreamSplitRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealDoublesByteStreamSplitParquetNetBenchmarks
{
    RealDoublesByteStreamSplitRow[] _rows = null!;
    ...
    public void Setup()
    {
        ...
        _options.ColumnEncodingHints["trip_distance"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["fare_amount"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["extra"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["mta_tax"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["tip_amount"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["tolls_amount"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["improvement_surcharge"] = EncodingHint.ByteSplitStream;
        _options.ColumnEncodingHints["total_amount"] = EncodingHint.ByteSplitStream;
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|RealDoublesByteStreamSplit|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = RealDoublesByteStreamSplitRow.CreateReadFile(_rows);
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealDoublesByteStreamSplitRow>(_stream!);
        double sum = 0;
