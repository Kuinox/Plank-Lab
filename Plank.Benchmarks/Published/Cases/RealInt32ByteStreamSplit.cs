...
public class RealInt32ByteStreamSplitPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32ByteStreamSplit", "Plank", out _expectedOutputBytes)];
    }
...
public class RealInt32ByteStreamSplitParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32ByteStreamSplit", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class RealInt32ByteStreamSplitParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32ByteStreamSplit", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("RealInt32ByteStreamSplit");
