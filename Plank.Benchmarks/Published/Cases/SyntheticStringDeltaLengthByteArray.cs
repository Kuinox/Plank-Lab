...
[ParquetSchema]
sealed partial class SyntheticStringDeltaLengthByteArrayPlankRow
{
    [ParquetColumn("value_0", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_0"), JsonPropertyName("value_0")]
    public ReadOnlyMemory<byte> Value0 { get; set; }

    [ParquetColumn("value_1", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_1"), JsonPropertyName("value_1")]
    public ReadOnlyMemory<byte> Value1 { get; set; }

    [ParquetColumn("value_2", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_2"), JsonPropertyName("value_2")]
    public ReadOnlyMemory<byte> Value2 { get; set; }

    [ParquetColumn("value_3", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_3"), JsonPropertyName("value_3")]
    public ReadOnlyMemory<byte> Value3 { get; set; }

    [ParquetColumn("value_4", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_4"), JsonPropertyName("value_4")]
    public ReadOnlyMemory<byte> Value4 { get; set; }

    [ParquetColumn("value_5", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_5"), JsonPropertyName("value_5")]
    public ReadOnlyMemory<byte> Value5 { get; set; }

    [ParquetColumn("value_6", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_6"), JsonPropertyName("value_6")]
    public ReadOnlyMemory<byte> Value6 { get; set; }

    [ParquetColumn("value_7", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_7"), JsonPropertyName("value_7")]
    public ReadOnlyMemory<byte> Value7 { get; set; }

    [ParquetColumn("value_8", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_8"), JsonPropertyName("value_8")]
    public ReadOnlyMemory<byte> Value8 { get; set; }

    [ParquetColumn("value_9", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_9"), JsonPropertyName("value_9")]
    public ReadOnlyMemory<byte> Value9 { get; set; }

    [ParquetColumn("value_10", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_10"), JsonPropertyName("value_10")]
    public ReadOnlyMemory<byte> Value10 { get; set; }

    [ParquetColumn("value_11", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_11"), JsonPropertyName("value_11")]
    public ReadOnlyMemory<byte> Value11 { get; set; }

    [ParquetColumn("value_12", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_12"), JsonPropertyName("value_12")]
    public ReadOnlyMemory<byte> Value12 { get; set; }

    [ParquetColumn("value_13", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_13"), JsonPropertyName("value_13")]
    public ReadOnlyMemory<byte> Value13 { get; set; }

    [ParquetColumn("value_14", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_14"), JsonPropertyName("value_14")]
    public ReadOnlyMemory<byte> Value14 { get; set; }

    [ParquetColumn("value_15", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_15"), JsonPropertyName("value_15")]
    public ReadOnlyMemory<byte> Value15 { get; set; }

    [ParquetColumn("value_16", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_16"), JsonPropertyName("value_16")]
    public ReadOnlyMemory<byte> Value16 { get; set; }

    [ParquetColumn("value_17", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_17"), JsonPropertyName("value_17")]
    public ReadOnlyMemory<byte> Value17 { get; set; }

    [ParquetColumn("value_18", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_18"), JsonPropertyName("value_18")]
    public ReadOnlyMemory<byte> Value18 { get; set; }

    [ParquetColumn("value_19", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_19"), JsonPropertyName("value_19")]
    public ReadOnlyMemory<byte> Value19 { get; set; }

    [ParquetColumn("value_20", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_20"), JsonPropertyName("value_20")]
    public ReadOnlyMemory<byte> Value20 { get; set; }

    [ParquetColumn("value_21", Encodings = [EncodingKind.DeltaLengthByteArray], LogicalType = LogicalTypeKind.String), MapToColumn("value_21"), JsonPropertyName("value_21")]
    public ReadOnlyMemory<byte> Value21 { get; set; }

    public static SyntheticStringDeltaLengthByteArrayPlankRow[] CreateRows(int count)
    {
        var rows = new SyntheticStringDeltaLengthByteArrayPlankRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticStringDeltaLengthByteArrayPlankRow
            {
    ...
    public static byte[] CreateReadFile(SyntheticStringDeltaLengthByteArrayPlankRow[] rows)
    {
    ...
    public static SyntheticStringDeltaLengthByteArrayPlankRow[] FromSharp(SyntheticStringDeltaLengthByteArraySharpRow[] source)
    {
        var rows = new SyntheticStringDeltaLengthByteArrayPlankRow[source.Length];
        for (var index = 0; index < rows.Length; index++)
        {
            var value = source[index];
            rows[index] = new SyntheticStringDeltaLengthByteArrayPlankRow
            {
    ...
    public static SyntheticStringDeltaLengthByteArrayPlankRow[] FromNet(SyntheticStringDeltaLengthByteArrayNetRow[] source)
    {
        var rows = new SyntheticStringDeltaLengthByteArrayPlankRow[source.Length];
        for (var index = 0; index < rows.Length; index++)
        {
...
sealed partial class SyntheticStringDeltaLengthByteArraySharpRow
{
    ...
    public static SyntheticStringDeltaLengthByteArraySharpRow[] CreateRows(int count)
    {
        var rows = new SyntheticStringDeltaLengthByteArraySharpRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticStringDeltaLengthByteArraySharpRow
            {
...
sealed partial class SyntheticStringDeltaLengthByteArrayNetRow
{
    ...
    public static SyntheticStringDeltaLengthByteArrayNetRow[] CreateRows(int count)
    {
        var rows = new SyntheticStringDeltaLengthByteArrayNetRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticStringDeltaLengthByteArrayNetRow
            {
                Value0 = BenchmarkData.StringValues[(row * 37 + 0 * 1009) & 2047],
                Value1 = BenchmarkData.StringValues[(row * 37 + 1 * 1009) & 2047],
                Value2 = BenchmarkData.StringValues[(row * 37 + 2 * 1009) & 2047],
...
[MemoryDiagnoser]
public class SyntheticStringDeltaLengthByteArrayPlankBenchmarks
{
    ...
    SyntheticStringDeltaLengthByteArrayPlankRow.PipelineWriter _writer = null!;
    MemoryStream _output = null!;
    int _outputCapacity;
    MemoryReadSource _source = null!;
    SyntheticStringDeltaLengthByteArrayPlankRow.RowReader _reader = null!;
    ...
    public void Setup()
    {
        ...
        _writer = SyntheticStringDeltaLengthByteArrayPlankRow.CreateRowWriter(_output, _options);
        Write();
        var file = _output.ToArray();
        Console.WriteLine("BENCHMARK_FILE|SyntheticStringDeltaLengthByteArray|Plank|" + file.Length);
        _outputCapacity = BenchmarkData.OutputCapacity(file.Length);
        _output.Dispose();

        _source = new MemoryReadSource(file);
        _reader = SyntheticStringDeltaLengthByteArrayPlankRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
        _ = Read();
    }
...
[MemoryDiagnoser]
public class SyntheticStringDeltaLengthByteArrayParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticStringDeltaLengthByteArraySharpRow> _writer = null!;
    int _outputCapacity;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticStringDeltaLengthByteArraySharpRow>? _reader;
    ...
    public void Setup()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticStringDeltaLengthByteArraySharpRow>(_managedOutput, _properties, _schema);
        Write();
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|SyntheticStringDeltaLengthByteArray|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticStringDeltaLengthByteArrayPlankRow.CreateReadFile(SyntheticStringDeltaLengthByteArrayPlankRow.FromSharp(_rows));
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticStringDeltaLengthByteArraySharpRow>(_source);
    }
...
[MemoryDiagnoser]
public class SyntheticStringDeltaLengthByteArrayParquetNetBenchmarks
{
    SyntheticStringDeltaLengthByteArrayNetRow[] _rows = null!;
    byte[] _file = null!;
    ...
    public void Setup()
    {
        _rows = SyntheticStringDeltaLengthByteArrayNetRow.CreateRows(Rows);

        _file = SyntheticStringDeltaLengthByteArrayPlankRow.CreateReadFile(SyntheticStringDeltaLengthByteArrayPlankRow.FromNet(_rows));
    }
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<SyntheticStringDeltaLengthByteArrayNetRow>(_stream!);
        ulong sum = 0;
