...
public class SyntheticStringDeltaLengthByteArrayPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringDeltaLengthByteArray", "Plank", out _expectedOutputBytes)];
    }
...
public class SyntheticStringDeltaLengthByteArrayParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticStringDeltaLengthByteArray", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class SyntheticStringDeltaLengthByteArrayParquetNetBenchmarks
{
    ...
    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticStringDeltaLengthByteArray");
