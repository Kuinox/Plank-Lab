...
[MemoryDiagnoser]
public class RealInt32DictionaryColumnPlankBenchmarks
{
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealInt32Dictionary"));
...
[MemoryDiagnoser]
public class RealInt32DictionaryColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    RealInt32DictionaryRow[] _rows = null!;
    MemoryStream _output = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt32DictionaryColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealInt32DictionaryColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    byte[] _file = null!;
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealInt32Dictionary");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
