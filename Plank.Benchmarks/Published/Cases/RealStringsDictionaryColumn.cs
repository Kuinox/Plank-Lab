...
[MemoryDiagnoser]
public class RealStringsDictionaryColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealStringsDictionaryPlankRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<ReadOnlyMemory<byte>?>(RealStringsDictionaryPlankRow.Schema.LeafColumns[0]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionaryColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealStringsDictionary"));
...
[MemoryDiagnoser]
public class RealStringsDictionaryColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionaryColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealStringsDictionaryColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _schema = new Parquet.Schema.ParquetSchema(new Parquet.Schema.DataField<string?>("store_and_fwd_flag", true));

        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsDictionaryColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealStringsDictionary");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
