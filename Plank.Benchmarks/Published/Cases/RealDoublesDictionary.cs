...
public class RealDoublesDictionaryPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesDictionary", "Plank", out _expectedOutputBytes)];
    }
...
public class RealDoublesDictionaryParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealDoublesDictionary", "ParquetSharp", out _expectedOutputBytes)];
    }
