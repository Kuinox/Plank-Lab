...
public class SyntheticTimestampPlainPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticTimestampPlainParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "ParquetSharp", out _expectedOutputBytes);
    }
...
public class SyntheticTimestampPlainParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "Parquet.Net", out _expectedOutputBytes);
    }
