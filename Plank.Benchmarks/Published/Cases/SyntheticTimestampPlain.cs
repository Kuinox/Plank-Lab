...
public class SyntheticTimestampPlainPlankBenchmarks
{
    ...
    SyntheticTimestampPlainRow.PipelineWriter _writer = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "Plank", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticTimestampPlainRow.CreateRowWriter(_output, _options);
        else
...
public class SyntheticTimestampPlainParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "ParquetSharp", out _expectedOutputBytes)];
    }
...
public class SyntheticTimestampPlainParquetNetBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticTimestampPlain", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("SyntheticTimestampPlain");
