...
[ParquetSchema]
sealed partial class SyntheticBooleanRleRow
{
    [ParquetColumn("value_0", Encodings = [EncodingKind.Rle]), MapToColumn("value_0"), JsonPropertyName("value_0")]
    public bool Value0 { get; set; }

    [ParquetColumn("value_1", Encodings = [EncodingKind.Rle]), MapToColumn("value_1"), JsonPropertyName("value_1")]
    public bool Value1 { get; set; }

    [ParquetColumn("value_2", Encodings = [EncodingKind.Rle]), MapToColumn("value_2"), JsonPropertyName("value_2")]
    public bool Value2 { get; set; }

    [ParquetColumn("value_3", Encodings = [EncodingKind.Rle]), MapToColumn("value_3"), JsonPropertyName("value_3")]
    public bool Value3 { get; set; }

    [ParquetColumn("value_4", Encodings = [EncodingKind.Rle]), MapToColumn("value_4"), JsonPropertyName("value_4")]
    public bool Value4 { get; set; }

    [ParquetColumn("value_5", Encodings = [EncodingKind.Rle]), MapToColumn("value_5"), JsonPropertyName("value_5")]
    public bool Value5 { get; set; }

    [ParquetColumn("value_6", Encodings = [EncodingKind.Rle]), MapToColumn("value_6"), JsonPropertyName("value_6")]
    public bool Value6 { get; set; }

    [ParquetColumn("value_7", Encodings = [EncodingKind.Rle]), MapToColumn("value_7"), JsonPropertyName("value_7")]
    public bool Value7 { get; set; }

    [ParquetColumn("value_8", Encodings = [EncodingKind.Rle]), MapToColumn("value_8"), JsonPropertyName("value_8")]
    public bool Value8 { get; set; }

    [ParquetColumn("value_9", Encodings = [EncodingKind.Rle]), MapToColumn("value_9"), JsonPropertyName("value_9")]
    public bool Value9 { get; set; }

    [ParquetColumn("value_10", Encodings = [EncodingKind.Rle]), MapToColumn("value_10"), JsonPropertyName("value_10")]
    public bool Value10 { get; set; }

    [ParquetColumn("value_11", Encodings = [EncodingKind.Rle]), MapToColumn("value_11"), JsonPropertyName("value_11")]
    public bool Value11 { get; set; }

    [ParquetColumn("value_12", Encodings = [EncodingKind.Rle]), MapToColumn("value_12"), JsonPropertyName("value_12")]
    public bool Value12 { get; set; }

    [ParquetColumn("value_13", Encodings = [EncodingKind.Rle]), MapToColumn("value_13"), JsonPropertyName("value_13")]
    public bool Value13 { get; set; }

    [ParquetColumn("value_14", Encodings = [EncodingKind.Rle]), MapToColumn("value_14"), JsonPropertyName("value_14")]
    public bool Value14 { get; set; }

    [ParquetColumn("value_15", Encodings = [EncodingKind.Rle]), MapToColumn("value_15"), JsonPropertyName("value_15")]
    public bool Value15 { get; set; }

    [ParquetColumn("value_16", Encodings = [EncodingKind.Rle]), MapToColumn("value_16"), JsonPropertyName("value_16")]
    public bool Value16 { get; set; }

    [ParquetColumn("value_17", Encodings = [EncodingKind.Rle]), MapToColumn("value_17"), JsonPropertyName("value_17")]
    public bool Value17 { get; set; }

    [ParquetColumn("value_18", Encodings = [EncodingKind.Rle]), MapToColumn("value_18"), JsonPropertyName("value_18")]
    public bool Value18 { get; set; }

    [ParquetColumn("value_19", Encodings = [EncodingKind.Rle]), MapToColumn("value_19"), JsonPropertyName("value_19")]
    public bool Value19 { get; set; }

    [ParquetColumn("value_20", Encodings = [EncodingKind.Rle]), MapToColumn("value_20"), JsonPropertyName("value_20")]
    public bool Value20 { get; set; }

    [ParquetColumn("value_21", Encodings = [EncodingKind.Rle]), MapToColumn("value_21"), JsonPropertyName("value_21")]
    public bool Value21 { get; set; }

    public static SyntheticBooleanRleRow[] CreateRows(int count)
    {
        var rows = new SyntheticBooleanRleRow[count];
        for (var row = 0; row < rows.Length; row++)
            rows[row] = new SyntheticBooleanRleRow
            {
                Value0 = ((row + 0) & 1) == 0,
                Value1 = ((row + 1) & 1) == 0,
                Value2 = ((row + 2) & 1) == 0,
    ...
    public static byte[] CreateReadFile(SyntheticBooleanRleRow[] rows)
    {
...
public class SyntheticBooleanRlePlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanRle", "Plank", out _expectedOutputBytes)];
    }
    ...
    public void GlobalSetupRead()
    {
        ...
        _reader = SyntheticBooleanRleRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = SyntheticBooleanRleRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class SyntheticBooleanRleParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<SyntheticBooleanRleRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<SyntheticBooleanRleRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanRle", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<SyntheticBooleanRleRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<SyntheticBooleanRleRow>(_source);
    }
