...
public class SyntheticBooleanRlePlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticBooleanRle|Plank|" + file.Length);
...
public class SyntheticBooleanRleParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|SyntheticBooleanRle|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = SyntheticBooleanRleRow.CreateReadFile(_rows);
