...
public class SyntheticBooleanRlePlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanRle", "Plank", out _expectedOutputBytes);
    }
...
public class SyntheticBooleanRleParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("SyntheticBooleanRle", "ParquetSharp", out _expectedOutputBytes);
    }
