...
public class RealInt64PlainPlankBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealInt64Plain|Plank|" + file.Length);
...
public class RealInt64PlainParquetSharpBenchmarks
{
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("BENCHMARK_FILE|RealInt64Plain|ParquetSharp|" + _output.Length);
        _writer.Dispose();
        _managedOutput.Dispose();
        _output.Dispose();

        var file = RealInt64PlainRow.CreateReadFile(_rows);
...
public class RealInt64PlainParquetNetBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _outputCapacity = BenchmarkData.OutputCapacity(checked((int)_output.Length));
        Console.WriteLine("BENCHMARK_FILE|RealInt64Plain|Parquet.Net|" + _output.Length);
        _output.Dispose();

        _file = RealInt64PlainRow.CreateReadFile(_rows);
    }
