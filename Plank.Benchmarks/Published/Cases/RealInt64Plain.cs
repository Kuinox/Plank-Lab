...
[ParquetSchema]
sealed partial class RealInt64PlainRow
{
    ...
    public static byte[] CreateReadFile(RealInt64PlainRow[] rows)
    {
...
public class RealInt64PlainPlankBenchmarks
{
    ...
    {
        _rows ??= BenchmarkData.LoadTaxiRows<RealInt64PlainRow>();
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64Plain", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        var file = BenchmarkFixtures.LoadReadFile("RealInt64Plain");
        _source = new MemoryReadSource(file);
        _reader = RealInt64PlainRow.CreateRowReader(_source, options: new RowReaderOptions { BufferPool = _pool });
    }
    ...
    public void SetupWrite()
    {
        ...
        _pinning.Reset();
        if (_writer is null)
            _writer = RealInt64PlainRow.CreateRowWriter(_output, _options);
        else
...
[MemoryDiagnoser]
public class RealInt64PlainParquetSharpBenchmarks
{
    ...
    ParquetRowWriter<RealInt64PlainRow> _writer = null!;
    byte[] _outputBuffer = null!;
    long _expectedOutputBytes;
    GCHandle _pinned;
    NativeBuffer _buffer = null!;
    BufferReader _source = null!;
    ParquetRowReader<RealInt64PlainRow>? _reader;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64Plain", "ParquetSharp", out _expectedOutputBytes)];
    }
    ...
    public void SetupWrite()
    {
        ...
        _writer = ParquetFile.CreateRowWriter<RealInt64PlainRow>(_managedOutput, _properties, _schema);
    }
    ...
    {
        _reader?.Dispose();
        _reader = ParquetFile.CreateRowReader<RealInt64PlainRow>(_source);
    }
...
[MemoryDiagnoser]
public class RealInt64PlainParquetNetBenchmarks
{
    RealInt64PlainRow[] _rows = null!;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealInt64Plain", "Parquet.Net", out _expectedOutputBytes)];
    }

    [GlobalSetup(Target = nameof(Read))]
    public void GlobalSetupRead() => _file = BenchmarkFixtures.LoadReadFile("RealInt64Plain");
    ...
    {
        var result = await ParquetSerializer.DeserializeAsync<RealInt64PlainRow>(_stream!);
        ulong sum = 0;
