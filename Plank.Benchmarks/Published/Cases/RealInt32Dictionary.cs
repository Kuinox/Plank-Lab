...
public class RealInt32DictionaryPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("RealInt32Dictionary", "Plank", out _expectedOutputBytes);
    }
...
public class RealInt32DictionaryParquetSharpBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputCapacity = BenchmarkFixtures.GetOutputCapacity("RealInt32Dictionary", "ParquetSharp", out _expectedOutputBytes);
    }
