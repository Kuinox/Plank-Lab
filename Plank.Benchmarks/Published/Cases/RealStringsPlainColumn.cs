...
[MemoryDiagnoser]
public class RealStringsPlainColumnPlankBenchmarks
{
    ...
    public void GlobalSetupWrite()
    {
        ...
        _writer = RealStringsPlainPlankRow.Schema.CreateWriter(preparationOutput, new ParquetWriterOptions
        ...
        _s0 = _writer.CreateSerializedColumn<ReadOnlyMemory<byte>?>(RealStringsPlainPlankRow.Schema.LeafColumns[0]);
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsPlainColumn", "Plank", out _expectedOutputBytes)];
    }
    ...
    {
        _pool = new DefaultParquetBufferPool(ParquetBufferRetentionPolicy.ZeroAllocation);
        _source = new MemoryReadSource(BenchmarkFixtures.LoadReadFile("RealStringsPlain"));
...
[MemoryDiagnoser]
public class RealStringsPlainColumnParquetSharpBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsPlainColumn", "ParquetSharp", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
...
[MemoryDiagnoser]
public class RealStringsPlainColumnParquetNetBenchmarks
{
    const int RowsPerRowGroup = 1048576;
    ...
    public void GlobalSetupWrite()
    {
        ...
        _outputBuffer = new byte[BenchmarkFixtures.GetOutputCapacity("RealStringsPlainColumn", "Parquet.Net", out _expectedOutputBytes)];
    }
    [IterationSetup(Target = nameof(Write))]
    public void SetupWrite()
    {
    ...
    public void GlobalSetupRead()
    {
        _file = BenchmarkFixtures.LoadReadFile("RealStringsPlain");
    }
    [IterationSetup(Target = nameof(Read))]
    public void SetupRead()
    {
